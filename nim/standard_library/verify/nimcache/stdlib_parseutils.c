...
/* Command for C compiler:
   gcc -c  -w -O3 -fno-strict-aliasing  -I/home/chaemon/.choosenim/toolchains/nim-0.13.0/lib -o /home/chaemon/git/library-1/nim/standard_library/verify/nimcache/stdlib_parseutils.o /home/chaemon/git/library-1/nim/standard_library/verify/nimcache/stdlib_parseutils.c */
...
N_NIMCALL(NI, rawparseint_95727)(NimStringDesc* s, NI64* b, NI start);
...
STRING_LITERAL(TMP57, "overflow", 8);
	...
	LA1: ;
	{
		...
		(*b) = IL64(0);
		{
			while (1) {
				...
				TMP50 = mulInt64((*b), IL64(10));
				TMP51 = subInt(((NI) (((NU8)(s->data[i])))), ((NI) 48));
				TMP52 = subInt64((NI64)(TMP50), ((NI64) ((NI)(TMP51))));
				(*b) = (NI64)(TMP52);
				TMP53 = addInt(i, ((NI) 1));
				i = (NI)(TMP53);
				{
		...
		TMP55 = mulInt64((*b), sign);
		(*b) = (NI64)(TMP55);
		TMP56 = subInt(i, start);
		result = (NI)(TMP56);
	}
	LA10: ;
	return result;
...
N_NIMCALL(NI, npuParseBiggestInt)(NimStringDesc* s, NI64* number, NI start) {
	...
	result = 0;
	res = 0;
	result = rawparseint_95727(s, (&res), start);
	(*number) = res;
	return result;
}
...
N_NIMCALL(NI, npuParseInt)(NimStringDesc* s, NI* number, NI start) {
	...
	result = npuParseBiggestInt(s, (&res), start);
	{
		...
		if (!LOC3) goto LA7;
		e_95841 = 0;
		e_95841 = (Overflowerror3640*) newObj((&NTI23869), sizeof(Overflowerror3640));
		(*e_95841).Sup.Sup.Sup.m_type = (&NTI3640);
		LOC9 = 0;
		LOC9 = (*e_95841).Sup.Sup.message; (*e_95841).Sup.Sup.message = copyStringRC1(((NimStringDesc*) &TMP57));
		if (LOC9) nimGCunrefNoCycle(LOC9);
		raiseException((Exception*)e_95841, "OverflowError");
	}
	goto LA1;
	LA7: ;
	{
