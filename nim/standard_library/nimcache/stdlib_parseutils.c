...
/* Command for C compiler:
   gcc -c  -w  -I/home/chaemon/.choosenim/toolchains/nim-0.13.0/lib -o /home/chaemon/git/library-1/nim/standard_library/nimcache/stdlib_parseutils.o /home/chaemon/git/library-1/nim/standard_library/nimcache/stdlib_parseutils.c */
...
N_NIMCALL(NI, rawparseint_95127)(NimStringDesc* s, NI64* b, NI start);
...
STRING_LITERAL(TMP217, "overflow", 8);
	...
	LA1: ;
	{
		...
		(*b) = IL64(0);
		{
			while (1) {
				...
				TMP210 = mulInt64((*b), IL64(10));
				TMP211 = subInt(((NI) (((NU8)(s->data[i])))), ((NI) 48));
				TMP212 = subInt64((NI64)(TMP210), ((NI64) ((NI)(TMP211))));
				(*b) = (NI64)(TMP212);
				TMP213 = addInt(i, ((NI) 1));
				i = (NI)(TMP213);
				{
					while (1) {
						NI TMP214;
		...
		TMP215 = mulInt64((*b), sign);
		(*b) = (NI64)(TMP215);
		TMP216 = subInt(i, start);
		result = (NI)(TMP216);
	}
	LA10: ;
	return result;
...
N_NIMCALL(NI, npuParseBiggestInt)(NimStringDesc* s, NI64* number, NI start) {
	...
	result = 0;
	res = 0;
	result = rawparseint_95127(s, (&res), start);
	(*number) = res;
	return result;
}
...
N_NIMCALL(NI, npuParseInt)(NimStringDesc* s, NI* number, NI start) {
	...
	result = npuParseBiggestInt(s, (&res), start);
	{
		...
		if (!LOC3) goto LA7;
		e_95241 = 0;
		e_95241 = (Overflowerror3640*) newObj((&NTI24269), sizeof(Overflowerror3640));
		(*e_95241).Sup.Sup.Sup.m_type = (&NTI3640);
		LOC9 = 0;
		LOC9 = (*e_95241).Sup.Sup.message; (*e_95241).Sup.Sup.message = copyStringRC1(((NimStringDesc*) &TMP217));
		if (LOC9) nimGCunrefNoCycle(LOC9);
		raiseException((Exception*)e_95241, "OverflowError");
	}
	goto LA1;
	LA7: ;
	{
