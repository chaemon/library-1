...
/* Command for C compiler:
   gcc -c  -w -O3 -fno-strict-aliasing  -I/home/chaemon/.choosenim/toolchains/nim-0.13.0/lib -o /home/chaemon/git/library-1/nim/math/verify/nimcache/aoj_dpl_5_c_test.o /home/chaemon/git/library-1/nim/math/verify/nimcache/aoj_dpl_5_c_test.c */
...
N_NIMCALL(void, HEX2BHEX3D_159904)(Mint159105* a, Mint159105 b);
N_NIMCALL(Mint159105, C_159804)(Combination159462* self, NI p, NI q);
N_NIMCALL(Mint159105, fact_159817)(Combination159462* self, NI k);
N_NIMCALL(Mint159105, rfact_159837)(Combination159462* self, NI k);
N_NIMCALL(Mint159105, pow_159196)(Mint159105 x_159198, NI n_159199);
N_NIMCALL(void, HEX2DHEX3D_159961)(Mint159105* a, Mint159105 b);
...
NIM_EXTERNC N_NOINLINE(void, aoj_dpl_5_c_testInit000)(void);
NIM_EXTERNC N_NOINLINE(void, aoj_dpl_5_c_testDatInit000)(void);
...
{	result_159479 = newseq_159483(((NI) ((NI)(sz + ((NI) 1)))));
	...
	facta->data[((NI) 0)] = convert_159579(LOC13, ((NI) 1));
	memset((void*)(&LOC14), 0, sizeof(LOC14));
	rfacta->data[sz] = convert_159579(LOC14, ((NI) 1));
	memset((void*)(&LOC15), 0, sizeof(LOC15));
	inva->data[((NI) 0)] = convert_159579(LOC15, ((NI) 1));
	{
		NI i_159621;
		NI res_159763;
		i_159621 = 0;
...
{	memset((void*)(&result), 0, sizeof(result));
	...
	LA5: ;
	LOC8 = fact_159817(self, p);
	LOC9 = rfact_159837(self, q);
	LOC10 = HEX2A_159710(LOC8, LOC9);
	LOC11 = rfact_159837(self, (NI)(p - q));
...
N_NIMCALL(void, main_159450)(void) {
	...
	memset((void*)(&T), 0, sizeof(T));
	initcombination_159455(k, (&T));
	s = initmint_159205(((NI) 0));
	{
		NI i_159801;
		NI res_159992;
		i_159801 = 0;
		res_159992 = ((NI) 1);
		{
			while (1) {
				...
				i_159801 = res_159992;
				{
					...
					Mint159105 LOC10;
					Mint159105 LOC11;
					if (!(((NI) ((NI)((NI)(k - i_159801) % ((NI) 2)))) == ((NI) 0))) goto LA6;
					LOC8 = C_159804((&T), k, i_159801);
					LOC9 = initmint_159205(i_159801);
					LOC10 = pow_159196(LOC9, n);
					LOC11 = HEX2A_159710(LOC8, LOC10);
					HEX2BHEX3D_159904((&s), LOC11);
				}
				goto LA4;
				LA6: ;
				{
					...
					Mint159105 LOC15;
					Mint159105 LOC16;
					LOC13 = C_159804((&T), k, i_159801);
					LOC14 = initmint_159205(i_159801);
					LOC15 = pow_159196(LOC14, n);
					LOC16 = HEX2A_159710(LOC13, LOC15);
					HEX2DHEX3D_159961((&s), LOC16);
				}
				LA4: ;
				res_159992 += ((NI) 1);
			} LA3: ;
	...
	LOC17 = 0;
	LOC17 = HEX24_159192(s);
	printf("%s\012", LOC17? (LOC17)->data:"nil");
	fflush(stdout);
}
