...
/* Command for C compiler:
   g++ -c  -w -w -fpermissive -O3 -fno-strict-aliasing  -I/home/chaemon/.choosenim/toolchains/nim-0.13.0/lib -o /home/chaemon/git/library-1/nim/math/verify/nimcache/aoj_ntl_1_a_test.o /home/chaemon/git/library-1/nim/math/verify/nimcache/aoj_ntl_1_a_test.cpp */
...
struct Orderedkeyvaluepairseq159113 : TGenericSeq {
...
N_NIMCALL(NI*, HEX5BHEX5D_159387)(Orderedtable159110& t, NI key);
...
{				goto LA1;
			...
			HEX5BHEX5DHEX3D_159213((*Result), i, ((NI) 0));
			{
				while (1) {
					...
					(*HEX5BHEX5D_159387((*Result), i)) += ((NI) 1);
					n = (NI)(n / i);
				} LA8: ;
			}
			i += ((NI) 1);
...
N_NIMCALL(void, main_159650)(void) {
	...
	LOC1[1] = copyString(((NimStringDesc*) &TMP39));
	...
	primefactor_159102(N, (&pf));
	{
		...
		k_159669 = 0;
		v_159670 = 0;
		NI h_159719 = pf.first;
		{
			while (1) {
				if (!(((NI) 0) <= h_159719)) goto LA4;
				NI nxt_159721 = pf.data->data[h_159719].Field1;
				{
					if (!isfilled_118263(pf.data->data[h_159719].Field0)) goto LA7;
{					k_159669 = pf.data->data[h_159719].Field2;
					v_159670 = pf.data->data[h_159719].Field3;
					{
						NI i_159696;
						Slice87882 HEX3Atmp_159703;
						i_159696 = 0;
						...
						HEX3Atmp_159703 = HEX2EHEX2E_102424(((NI) 0), (v_159670 - 1));
						{
							...
							NI res_159713 = HEX3Atmp_159709;
							{
								while (1) {
									TY159653 LOC13;
									if (!(res_159713 <= HEX3Atmp_159711)) goto LA12;
									x_159707 = res_159713;
									i_159696 = x_159707;
									memset((void*)LOC13, 0, sizeof(LOC13));
									LOC13[0] = copyString(((NimStringDesc*) &TMP47));
									LOC13[1] = nimIntToStr(k_159669);
									write_15505(stdout, LOC13, 2);
									res_159713 += ((NI) 1);
								} LA12: ;
							}
						}
	...
	printf("%s\012", ((NimStringDesc*) &TMP48)? (((NimStringDesc*) &TMP48))->data:"nil");
	fflush(stdout);
}
