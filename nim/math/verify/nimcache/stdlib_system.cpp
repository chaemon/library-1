...
/* Command for C compiler:
   g++ -c  -w -w -fpermissive -O3 -fno-strict-aliasing  -I/home/chaemon/.choosenim/toolchains/nim-0.13.0/lib -o /home/chaemon/git/library-1/nim/math/verify/nimcache/stdlib_system.o /home/chaemon/git/library-1/nim/math/verify/nimcache/stdlib_system.cpp */
...
TNimType NTI104; /* int */
extern TNimType NTI159351; /* seq[seq[Mint]] */
...
extern TNimType NTI159352; /* seq[Mint] */
...
N_NOINLINE(void, raiseOverflow)(void) {
	sysfatal_23663(((NimStringDesc*) &TMP40));
}
...
N_NIMCALL(TY159351*, newseq_159377)(NI len) {
	TY159351* result;
	result = 0;
	result = (TY159351*) newSeq((&NTI159351), len);
	return result;
}
...
N_NIMCALL(TY159352*, newseq_159359)(NI len) {
	TY159352* result;
	result = 0;
	result = (TY159352*) newSeq((&NTI159352), len);
	return result;
}
