...
/* Command for C compiler:
   gcc -c  -w -O3 -fno-strict-aliasing  -I/home/chaemon/.choosenim/toolchains/nim-0.13.0/lib -o /home/chaemon/git/library-1/nim/math/verify/nimcache/aoj_dpl_5_d_test.o /home/chaemon/git/library-1/nim/math/verify/nimcache/aoj_dpl_5_d_test.c */
...
NIM_EXTERNC N_NOINLINE(void, aoj_dpl_5_d_testInit000)(void);
NIM_EXTERNC N_NOINLINE(void, aoj_dpl_5_d_testDatInit000)(void);
...
N_NIMCALL(void, main_159450)(void) {
	...
	memset((void*)(&T), 0, sizeof(T));
	initcombination_159455((NI)((NI)(n + k) - ((NI) 1)), (&T));
	LOC1 = C_159785((&T), (NI)((NI)(n + k) - ((NI) 1)), n);
	LOC2 = 0;
