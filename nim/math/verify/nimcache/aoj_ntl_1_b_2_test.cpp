...
/* Command for C compiler:
   g++ -c  -w -w -fpermissive -O3 -fno-strict-aliasing  -I/home/chaemon/.choosenim/toolchains/nim-0.13.0/lib -o /home/chaemon/git/library-1/nim/math/verify/nimcache/aoj_ntl_1_b_2_test.o /home/chaemon/git/library-1/nim/math/verify/nimcache/aoj_ntl_1_b_2_test.cpp */
...
N_NIMCALL(void, main_159320)(void);
...
N_NIMCALL(void, main_159320)(void) {
	NimStringDesc* LOC1;
	Mint159105 M = newmint_159205(nextint_159016(((NI) 0)));
	NI N = nextint_159016(((NI) 0));
	LOC1 = 0;
	LOC1 = HEX24_159192(pow_159196(M, N));
