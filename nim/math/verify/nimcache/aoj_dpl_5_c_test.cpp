...
/* Command for C compiler:
   g++ -c  -w -w -fpermissive -O3 -fno-strict-aliasing  -I/home/chaemon/.choosenim/toolchains/nim-0.13.0/lib -o /home/chaemon/git/library-1/nim/math/verify/nimcache/aoj_dpl_5_c_test.o /home/chaemon/git/library-1/nim/math/verify/nimcache/aoj_dpl_5_c_test.cpp */
...
N_NIMCALL(void, HEX2BHEX3D_159909)(Mint159105& a, Mint159105 b);
N_NIMCALL(Mint159105, C_159806)(Combination159464& self, NI p, NI q);
N_NIMCALL(Mint159105, fact_159819)(Combination159464& self, NI k);
N_NIMCALL(Mint159105, rfact_159840)(Combination159464& self, NI k);
N_NIMCALL(Mint159105, pow_159196)(Mint159105 x_159198, NI n_159199);
N_NIMCALL(void, HEX2DHEX3D_159966)(Mint159105& a, Mint159105 b);
...
{		memset((void*)(&LOC7), 0, sizeof(LOC7));
	...
	LA5: ;
	result = HEX2A_159712(HEX2A_159712(fact_159819(self, p), rfact_159840(self, q)), rfact_159840(self, (NI)(p - q)));
	goto BeforeRet;
	}BeforeRet: ;
	return result;
}
...
N_NIMCALL(void, main_159452)(void) {
	...
	memset((void*)(&T), 0, sizeof(T));
	newcombination_159457(k, (&T));
	Mint159105 s = newmint_159205(((NI) 0));
	{
		NI i_159803;
		i_159803 = 0;
		NI res_159997 = ((NI) 1);
		{
			while (1) {
				if (!(res_159997 <= k)) goto LA3;
				i_159803 = res_159997;
				{
					if (!(((NI) ((NI)((NI)(k - i_159803) % ((NI) 2)))) == ((NI) 0))) goto LA6;
{					HEX2BHEX3D_159909(s, HEX2A_159712(C_159806(T, k, i_159803), pow_159196(newmint_159205(i_159803), n)));
}				}
				goto LA4;
				LA6: ;
				{
					HEX2DHEX3D_159966(s, HEX2A_159712(C_159806(T, k, i_159803), pow_159196(newmint_159205(i_159803), n)));
				}
				LA4: ;
				res_159997 += ((NI) 1);
			} LA3: ;
