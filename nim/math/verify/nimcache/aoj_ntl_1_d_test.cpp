...
/* Command for C compiler:
   g++ -c  -w -w -fpermissive -O3 -fno-strict-aliasing  -I/home/chaemon/.choosenim/toolchains/nim-0.13.0/lib -o /home/chaemon/git/library-1/nim/math/verify/nimcache/aoj_ntl_1_d_test.o /home/chaemon/git/library-1/nim/math/verify/nimcache/aoj_ntl_1_d_test.cpp */
...
N_NIMCALL(void, main_159137)(void);
N_NIMCALL(NI, nextint_159016)(NI base);
N_NIMCALL(NI, eulerphi_159102)(NI n_159104);
...
NIM_EXTERNC N_NOINLINE(void, aoj_ntl_1_d_testInit000)(void);
NIM_EXTERNC N_NOINLINE(void, aoj_ntl_1_d_testDatInit000)(void);
...
{	result = 0;
	...
	{
		while (1) {
			if (!((NI)(i * i) <= n)) goto LA2;
			{
				if (!((NI)(n % i) == ((NI) 0))) goto LA5;
{				result -= (NI)(result / i);
				{
					while (1) {
