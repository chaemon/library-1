...
/* Command for C compiler:
   gcc -c  -w -O3 -fno-strict-aliasing  -I/home/chaemon/.choosenim/toolchains/nim-0.13.0/lib -o /home/chaemon/git/library-1/nim/math/verify/nimcache/aoj_dpl_5_b_test.o /home/chaemon/git/library-1/nim/math/verify/nimcache/aoj_dpl_5_b_test.c */
...
N_NIMCALL(Mint159105, P_159785)(Combination159462* self, NI n, NI r);
...
NIM_EXTERNC N_NOINLINE(void, aoj_dpl_5_b_testInit000)(void);
NIM_EXTERNC N_NOINLINE(void, aoj_dpl_5_b_testDatInit000)(void);
...
{	memset((void*)(&result), 0, sizeof(result));
	...
	LA5: ;
	LOC8 = fact_159798(self, n);
	LOC9 = rfact_159818(self, (NI)(n - r));
	result = HEX2A_159710(LOC8, LOC9);
	goto BeforeRet;
	}BeforeRet: ;
	return result;
}
