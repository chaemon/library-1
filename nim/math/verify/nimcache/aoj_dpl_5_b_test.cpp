...
/* Command for C compiler:
   g++ -c  -w -w -fpermissive -O3 -fno-strict-aliasing  -I/home/chaemon/.choosenim/toolchains/nim-0.13.0/lib -o /home/chaemon/git/library-1/nim/math/verify/nimcache/aoj_dpl_5_b_test.o /home/chaemon/git/library-1/nim/math/verify/nimcache/aoj_dpl_5_b_test.cpp */
...
N_NIMCALL(Mint159105, P_159787)(Combination159464& self, NI n, NI r);
...
{		memset((void*)(&LOC7), 0, sizeof(LOC7));
	...
	LA5: ;
	result = HEX2A_159712(fact_159800(self, n), rfact_159821(self, (NI)(n - r)));
	goto BeforeRet;
	}BeforeRet: ;
	return result;
}
...
N_NIMCALL(void, main_159452)(void) {
	...
	LOC1 = 0;
	LOC1 = HEX24_159192(P_159787(T, k, n));
