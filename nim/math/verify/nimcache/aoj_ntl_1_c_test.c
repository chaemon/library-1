...
/* Command for C compiler:
   gcc -c  -w -O3 -fno-strict-aliasing  -I/home/chaemon/.choosenim/toolchains/nim-0.13.0/lib -o /home/chaemon/git/library-1/nim/math/verify/nimcache/aoj_ntl_1_c_test.o /home/chaemon/git/library-1/nim/math/verify/nimcache/aoj_ntl_1_c_test.c */
#define NIM_INTBITS 64

#include "nimbase.h"
#include <stdio.h>
typedef struct TY159154 TY159154;
...
N_NIMCALL(TY159154*, newseq_159149)(NI len);
...
N_NIMCALL(void, main_159141)(void) {
	NI n;
	TY159154* a;
	TY159154* result_159145;
	NI l;
	NimStringDesc* LOC7;
	n = nextint_159016(((NI) 0));
	result_159145 = newseq_159149(((NI) (n)));
	{
		NI i_159147;
		NI HEX3Atmp_159406;
		NI res_159409;
		...
		res_159409 = ((NI) 0);
		{
			while (1) {
				...
				i_159147 = res_159409;
				result_159145->data[i_159147] = nextint_159016(((NI) 0));
				res_159409 += ((NI) 1);
			} LA3: ;
		}
	}
